...
class DoctorViewModel : ViewModel() {
    ...
    private val doctorArrayList: ArrayList<Doctor?>? = ArrayList()
    var doctor: MutableLiveData<ArrayList<Doctor?>?>? = MutableLiveData()
    private var liveData: MutableLiveData<ArrayList<Doctor?>?>? = null
    ...
    fun getDoctorsList(): LiveData<ArrayList<Doctor?>?>? {
        return liveData
    }

    fun getDoctors(): MutableLiveData<ArrayList<Doctor?>?>? {
        fetchDoctor()
        return doctor
    }
            ...
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    for (document in task.result) {
                        val d = document.toObject(Doctor::class.java)
